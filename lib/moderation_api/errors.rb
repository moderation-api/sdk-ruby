  ...
  module Errors
    ...
    class APIStatusError < ModerationAPI::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          ModerationAPI::Errors::BadRequestError.new(**kwargs)
        in 401
          ModerationAPI::Errors::AuthenticationError.new(**kwargs)
        in 403
          ModerationAPI::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          ModerationAPI::Errors::NotFoundError.new(**kwargs)
        in 409
          ModerationAPI::Errors::ConflictError.new(**kwargs)
        in 422
          ModerationAPI::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          ModerationAPI::Errors::RateLimitError.new(**kwargs)
        in (500..)
          ModerationAPI::Errors::InternalServerError.new(**kwargs)
        else
          ModerationAPI::Errors::APIStatusError.new(**kwargs)
        end
      end
