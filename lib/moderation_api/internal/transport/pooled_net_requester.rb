      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - ModerationAPI::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = ModerationAPI::Internal::Util.uri_origin(url)
          timeout = deadline - ModerationAPI::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise ModerationAPI::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise ModerationAPI::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = ModerationAPI::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          end
