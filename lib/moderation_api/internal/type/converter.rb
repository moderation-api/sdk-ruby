    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { ModerationAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { ModerationAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            ModerationAPI::FilePart.new(value)
          in ModerationAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in ModerationAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [ModerationAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: ModerationAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in ModerationAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in ModerationAPI::Internal::Type::Converter
              ...
              ModerationAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(ModerationAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end
