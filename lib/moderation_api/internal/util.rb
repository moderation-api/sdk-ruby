    ...
    module Util
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(ModerationAPI::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in ModerationAPI::FilePart unless val.filename.nil?
          ...
          strio = writable_enum do |y|
            ...
            in Hash
              body.each do |key, val|
                case val
                in Array if val.all? { primitive?(_1) || ModerationAPI::Internal::Type::FileInput === _1 }
                  val.each do |v|
        ...
        def encode_content(headers, body)
          ...
          in [ModerationAPI::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [ModerationAPI::Internal::Util::JSONL_CONTENT, Enumerable] unless ModerationAPI::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | ModerationAPI::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [ModerationAPI::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in ModerationAPI::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
