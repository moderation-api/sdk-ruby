...
module ModerationAPI
  module Models
    ...
    class ActionCreateParams < ModerationAPI::Internal::Type::BaseModel
      ...
      #   only).
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateParams::Position, nil]
      optional :position, enum: -> { ModerationAPI::ActionCreateParams::Position }

      # @!attribute possible_values
      #   The possible values of the action. The user will be prompted to select one of
      #   these values when executing the action.
      #
      #   @return [Array<ModerationAPI::Models::ActionCreateParams::PossibleValue>, nil]
      optional :possible_values,
               -> {
                 ModerationAPI::Internal::Type::ArrayOf[ModerationAPI::ActionCreateParams::PossibleValue]
               },
      ...
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateParams::QueueBehaviour, nil]
      optional :queue_behaviour,
               enum: -> { ModerationAPI::ActionCreateParams::QueueBehaviour },
               api_name: :queueBehaviour

      # @!attribute type
      #   The type of the action.
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateParams::Type, nil]
      optional :type, enum: -> { ModerationAPI::ActionCreateParams::Type }, nil?: true
