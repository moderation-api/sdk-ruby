...
module ModerationAPI
  module Models
    # @see ModerationAPI::Resources::Actions#create
    class ActionCreateResponse < ModerationAPI::Internal::Type::BaseModel
      ...
      #   only).
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateResponse::Position]
      required :position, enum: -> { ModerationAPI::Models::ActionCreateResponse::Position }

      # @!attribute possible_values
      #   The possible values of the action. The user will be prompted to select one of
      #   these values when executing the action.
      #
      #   @return [Array<ModerationAPI::Models::ActionCreateResponse::PossibleValue>]
      required :possible_values,
               -> { ModerationAPI::Internal::Type::ArrayOf[ModerationAPI::Models::ActionCreateResponse::PossibleValue] },
      ...
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateResponse::QueueBehaviour]
      required :queue_behaviour,
               enum: -> { ModerationAPI::Models::ActionCreateResponse::QueueBehaviour },
      ...
      #
      #   @return [Symbol, ModerationAPI::Models::ActionCreateResponse::Type, nil]
      optional :type, enum: -> { ModerationAPI::Models::ActionCreateResponse::Type }, nil?: true
      ...
      #   {ModerationAPI::Models::ActionCreateResponse} for more details.
      #
      ...
      #
      #   @param position [Symbol, ModerationAPI::Models::ActionCreateResponse::Position] Show the action in all queues, selected queues or no queues (to use via API only
      #
      #   @param possible_values [Array<ModerationAPI::Models::ActionCreateResponse::PossibleValue>] The possible values of the action. The user will be prompted to select one of th
      #
      #   @param queue_behaviour [Symbol, ModerationAPI::Models::ActionCreateResponse::QueueBehaviour] Whether the action resolves and removes the item, unresolves and re-add it to th
      #
      ...
      #
      #   @param type [Symbol, ModerationAPI::Models::ActionCreateResponse::Type, nil] The type of the action.

      # Show the action in all queues, selected queues or no queues (to use via API
      # only).
      #
      # @see ModerationAPI::Models::ActionCreateResponse#position
      module Position
      ...
      # the queue, or does not change the resolve status.
      #
      # @see ModerationAPI::Models::ActionCreateResponse#queue_behaviour
      ...
      # The type of the action.
      #
      # @see ModerationAPI::Models::ActionCreateResponse#type
      module Type
        extend ModerationAPI::Internal::Type::Enum
