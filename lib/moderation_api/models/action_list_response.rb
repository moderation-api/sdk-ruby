...
module ModerationAPI
  module Models
    class ActionListResponseItem < ModerationAPI::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   only).
      #
      #   @return [Symbol, ModerationAPI::Models::ActionListResponseItem::Position]
      required :position, enum: -> { ModerationAPI::Models::ActionListResponseItem::Position }

      # @!attribute possible_values
      #   The possible values of the action. The user will be prompted to select one of
      #   these values when executing the action.
      #
      #   @return [Array<ModerationAPI::Models::ActionListResponseItem::PossibleValue>]
      required :possible_values,
               -> { ModerationAPI::Internal::Type::ArrayOf[ModerationAPI::Models::ActionListResponseItem::PossibleValue] },
      ...
      #
      #   @return [Symbol, ModerationAPI::Models::ActionListResponseItem::QueueBehaviour]
      required :queue_behaviour,
               enum: -> { ModerationAPI::Models::ActionListResponseItem::QueueBehaviour },
      ...
      #
      #   @param position [Symbol, ModerationAPI::Models::ActionListResponseItem::Position] Show the action in all queues, selected queues or no queues (to use via API only
      #
      #   @param possible_values [Array<ModerationAPI::Models::ActionListResponseItem::PossibleValue>] The possible values of the action. The user will be prompted to select one of th
      #
      #   @param queue_behaviour [Symbol, ModerationAPI::Models::ActionListResponseItem::QueueBehaviour] Whether the action resolves and removes the item, unresolves and re-add it to th
      #
      ...
      #
      #   @param type [Symbol, ModerationAPI::Models::ActionListResponseItem::Type, nil] The type of the action.

      # Show the action in all queues, selected queues or no queues (to use via API
      # only).
      #
      # @see ModerationAPI::Models::ActionListResponseItem#position
      module Position
      ...
      # the queue, or does not change the resolve status.
      #
      # @see ModerationAPI::Models::ActionListResponseItem#queue_behaviour
    ...
    ActionListResponse =
      ModerationAPI::Internal::Type::ArrayOf[-> { ModerationAPI::Models::ActionListResponseItem }]
  end
end
