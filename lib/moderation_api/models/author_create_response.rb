...
module ModerationAPI
  module Models
    ...
    class AuthorCreateResponse < ModerationAPI::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [ModerationAPI::Models::AuthorCreateResponse::Block, nil]
      required :block, -> { ModerationAPI::Models::AuthorCreateResponse::Block }, nil?: true
      ...
      #
      #   @return [ModerationAPI::Models::AuthorCreateResponse::Metadata]
      required :metadata, -> { ModerationAPI::Models::AuthorCreateResponse::Metadata }

      # @!attribute metrics
      #
      #   @return [ModerationAPI::Models::AuthorCreateResponse::Metrics]
      required :metrics, -> { ModerationAPI::Models::AuthorCreateResponse::Metrics }

      # @!attribute risk_evaluation
      #   Risk assessment details, if available.
      #
      #   @return [ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation, nil]
      required :risk_evaluation, -> { ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation }, nil?: true

      # @!attribute status
      #   Current author status
      #
      #   @return [Symbol, ModerationAPI::Models::AuthorCreateResponse::Status]
      required :status, enum: -> { ModerationAPI::Models::AuthorCreateResponse::Status }
      ...
      #
      #   @param block [ModerationAPI::Models::AuthorCreateResponse::Block, nil] Block or suspension details, if applicable. Null if the author is enabled.
      #
      #   @param first_seen [Float] Timestamp when author first appeared
      #
      #   @param last_seen [Float] Timestamp of last activity
      #
      #   @param metadata [ModerationAPI::Models::AuthorCreateResponse::Metadata] Additional metadata provided by your system. We recommend including any relevant
      #
      #   @param metrics [ModerationAPI::Models::AuthorCreateResponse::Metrics]
      #
      #   @param risk_evaluation [ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation, nil] Risk assessment details, if available.
      #
      #   @param status [Symbol, ModerationAPI::Models::AuthorCreateResponse::Status] Current author status
      #
      ...
      # @see ModerationAPI::Models::AuthorCreateResponse#block
      ...
      # @see ModerationAPI::Models::AuthorCreateResponse#metadata
      ...
      # @see ModerationAPI::Models::AuthorCreateResponse#metrics
      class Metrics < ModerationAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModerationAPI::Models::AuthorCreateResponse::Metrics} for more details.
        #
      ...
      # @see ModerationAPI::Models::AuthorCreateResponse#risk_evaluation
      ...
      # Current author status
      #
      # @see ModerationAPI::Models::AuthorCreateResponse#status
      module Status
      ...
      # @see ModerationAPI::Models::AuthorCreateResponse#trust_level
