      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    ModerationAPI::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              req:
                ModerationAPI::Internal::Transport::BaseClient::RequestComponents
            ).void
          end
          def validate!(req)
          end
          ...
          sig do
            params(
              request:
                ModerationAPI::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status: T.any(Integer, ModerationAPI::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(ModerationAPI::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req:
                ModerationAPI::Internal::Transport::BaseClient::RequestComponents,
              opts: ModerationAPI::Internal::AnyHash
            )
            .returns(
              ModerationAPI::Internal::Transport::BaseClient::RequestInput
            )
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: ModerationAPI::Internal::Type::Unknown,
          options: {}
        )
        end
