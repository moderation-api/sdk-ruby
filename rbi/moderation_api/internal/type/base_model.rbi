    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: ModerationAPI::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  ModerationAPI::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            params(
              ...
              spec: ModerationAPI::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: ModerationAPI::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: ModerationAPI::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: ModerationAPI::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(ModerationAPI::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(ModerationAPI::Internal::AnyHash) }
        def to_h
        end
