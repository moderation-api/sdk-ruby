...
module ModerationAPI
  module Models
    class ActionListResponseItem < ModerationAPI::Internal::Type::BaseModel
      ...
      sig do
        returns(
          ModerationAPI::Models::ActionListResponseItem::Position::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[ModerationAPI::Models::ActionListResponseItem::PossibleValue]
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            ModerationAPI::Models::ActionListResponseItem::Type::TaggedSymbol
          )
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          name: String,
          position:
            ModerationAPI::Models::ActionListResponseItem::Position::OrSymbol,
          possible_values:
            T::Array[
              ModerationAPI::Models::ActionListResponseItem::PossibleValue::OrHash
            ],
          queue_behaviour:
          ...
          type:
            T.nilable(
              ModerationAPI::Models::ActionListResponseItem::Type::OrSymbol
            )
        ...
        override.returns(
          {
            ...
            possible_values:
              T::Array[
                ModerationAPI::Models::ActionListResponseItem::PossibleValue
              ],
            queue_behaviour:
              ModerationAPI::Models::ActionListResponseItem::QueueBehaviour::TaggedSymbol,
            value_required: T::Boolean,
      ...
      module Position
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModerationAPI::Models::ActionListResponseItem::Position
            )
          end
      ...
      module QueueBehaviour
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModerationAPI::Models::ActionListResponseItem::QueueBehaviour
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::ActionListResponseItem::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
