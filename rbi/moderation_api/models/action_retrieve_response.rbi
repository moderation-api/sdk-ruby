  ...
  module Models
    class ActionRetrieveResponse < ModerationAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::Models::ActionRetrieveResponse,
      ...
      sig do
        returns(
          ModerationAPI::Models::ActionRetrieveResponse::Position::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[ModerationAPI::Models::ActionRetrieveResponse::PossibleValue]
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            ModerationAPI::Models::ActionRetrieveResponse::Type::TaggedSymbol
          )
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          name: String,
          position:
            ModerationAPI::Models::ActionRetrieveResponse::Position::OrSymbol,
          possible_values:
            T::Array[
              ModerationAPI::Models::ActionRetrieveResponse::PossibleValue::OrHash
            ],
          queue_behaviour:
          ...
          type:
            T.nilable(
              ModerationAPI::Models::ActionRetrieveResponse::Type::OrSymbol
            )
        ...
        override.returns(
          {
            ...
            possible_values:
              T::Array[
                ModerationAPI::Models::ActionRetrieveResponse::PossibleValue
              ],
            queue_behaviour:
              ModerationAPI::Models::ActionRetrieveResponse::QueueBehaviour::TaggedSymbol,
            value_required: T::Boolean,
      ...
      module Position
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModerationAPI::Models::ActionRetrieveResponse::Position
            )
          end
      ...
      module QueueBehaviour
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModerationAPI::Models::ActionRetrieveResponse::QueueBehaviour
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::ActionRetrieveResponse::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
