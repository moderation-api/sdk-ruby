  ...
  module Models
    class ActionUpdateParams < ModerationAPI::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::ActionUpdateParams,
      ...
      sig do
        returns(
          T.nilable(ModerationAPI::ActionUpdateParams::Position::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[ModerationAPI::ActionUpdateParams::PossibleValue])
        )
      end
      ...
      sig do
        returns(
          T.nilable(ModerationAPI::ActionUpdateParams::QueueBehaviour::OrSymbol)
        )
      end
      ...
      sig do
        returns(T.nilable(ModerationAPI::ActionUpdateParams::Type::OrSymbol))
      end
      attr_accessor :type
        ...
        override.returns(
          {
            ...
            position: ModerationAPI::ActionUpdateParams::Position::OrSymbol,
            possible_values:
              T::Array[ModerationAPI::ActionUpdateParams::PossibleValue],
            queue_behaviour:
              ModerationAPI::ActionUpdateParams::QueueBehaviour::OrSymbol,
            type: T.nilable(ModerationAPI::ActionUpdateParams::Type::OrSymbol),
            value_required: T::Boolean,
      ...
      module Position
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::ActionUpdateParams::Position)
          end
        ...
        ALL_QUEUES =
          T.let(
            :ALL_QUEUES,
            ModerationAPI::ActionUpdateParams::Position::TaggedSymbol
          )
        SOME_QUEUES =
          T.let(
            :SOME_QUEUES,
        ...
        sig do
          override.returns(
            T::Array[ModerationAPI::ActionUpdateParams::Position::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class PossibleValue < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::ActionUpdateParams::PossibleValue,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      module QueueBehaviour
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::ActionUpdateParams::QueueBehaviour)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        REMOVE =
          T.let(
            :REMOVE,
            ModerationAPI::ActionUpdateParams::QueueBehaviour::TaggedSymbol
          )
        ADD =
          T.let(
            :ADD,
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::ActionUpdateParams::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        sig do
          override.returns(
            T::Array[ModerationAPI::ActionUpdateParams::Type::TaggedSymbol]
          )
        end
        def self.values
        end
