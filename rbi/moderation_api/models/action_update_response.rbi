...
module ModerationAPI
  module Models
    class ActionUpdateResponse < ModerationAPI::Internal::Type::BaseModel
      ...
      sig do
        returns(
          ModerationAPI::Models::ActionUpdateResponse::Position::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[ModerationAPI::Models::ActionUpdateResponse::PossibleValue]
        )
      end
      ...
      sig do
        returns(
          ModerationAPI::Models::ActionUpdateResponse::QueueBehaviour::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            ModerationAPI::Models::ActionUpdateResponse::Type::TaggedSymbol
          )
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          name: String,
          position:
            ModerationAPI::Models::ActionUpdateResponse::Position::OrSymbol,
          possible_values:
            T::Array[
              ModerationAPI::Models::ActionUpdateResponse::PossibleValue::OrHash
            ],
          queue_behaviour:
            ModerationAPI::Models::ActionUpdateResponse::QueueBehaviour::OrSymbol,
          value_required: T::Boolean,
          description: T.nilable(String),
          key: T.nilable(String),
          type:
            T.nilable(
              ModerationAPI::Models::ActionUpdateResponse::Type::OrSymbol
            )
        ...
        override.returns(
          {
            ...
            possible_values:
              T::Array[
                ModerationAPI::Models::ActionUpdateResponse::PossibleValue
              ],
            queue_behaviour:
              ModerationAPI::Models::ActionUpdateResponse::QueueBehaviour::TaggedSymbol,
            value_required: T::Boolean,
      ...
      module Position
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::ActionUpdateResponse::Position)
          end
      ...
      module QueueBehaviour
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModerationAPI::Models::ActionUpdateResponse::QueueBehaviour
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::ActionUpdateResponse::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
