  ...
  module Models
    class AuthorCreateResponse < ModerationAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::Models::AuthorCreateResponse,
      ...
      sig do
        returns(T.nilable(ModerationAPI::Models::AuthorCreateResponse::Block))
      end
      attr_reader :block
      ...
      sig do
        params(
          block:
            T.nilable(
              ModerationAPI::Models::AuthorCreateResponse::Block::OrHash
            )
        ).void
      end
      attr_writer :block
      ...
      sig { returns(ModerationAPI::Models::AuthorCreateResponse::Metadata) }
      attr_reader :metadata

      sig do
        params(
          metadata:
            ModerationAPI::Models::AuthorCreateResponse::Metadata::OrHash
        ).void
      end
      attr_writer :metadata

      sig { returns(ModerationAPI::Models::AuthorCreateResponse::Metrics) }
      attr_reader :metrics

      sig do
        params(
          metrics: ModerationAPI::Models::AuthorCreateResponse::Metrics::OrHash
        ).void
      end
      attr_writer :metrics
      ...
      sig do
        returns(
          T.nilable(ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation)
        )
      end
      ...
      sig do
        params(
          risk_evaluation:
            T.nilable(
              ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation::OrHash
            )
        ).void
      end
      ...
      sig { returns(ModerationAPI::Models::AuthorCreateResponse::TrustLevel) }
        ...
        override.returns(
          {
            id: String,
            block:
              T.nilable(ModerationAPI::Models::AuthorCreateResponse::Block),
            first_seen: Float,
            last_seen: Float,
            ...
            risk_evaluation:
              T.nilable(
                ModerationAPI::Models::AuthorCreateResponse::RiskEvaluation
              ),
            status:
              ModerationAPI::Models::AuthorCreateResponse::Status::TaggedSymbol,
            trust_level:
      ...
      class Block < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorCreateResponse::Block,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      class Metadata < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorCreateResponse::Metadata,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::AuthorCreateResponse::Status)
          end
