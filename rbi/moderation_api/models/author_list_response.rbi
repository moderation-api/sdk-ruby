  ...
  module Models
    class AuthorListResponse < ModerationAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::Models::AuthorListResponse,
            ModerationAPI::Internal::AnyHash
          )
        end

      sig do
        returns(T::Array[ModerationAPI::Models::AuthorListResponse::Author])
      end
      attr_accessor :authors

      sig { returns(ModerationAPI::Models::AuthorListResponse::Pagination) }
      attr_reader :pagination

      sig do
        params(
          pagination:
            ModerationAPI::Models::AuthorListResponse::Pagination::OrHash
        ).void
      end
      ...
      sig do
        params(
          authors:
            T::Array[ModerationAPI::Models::AuthorListResponse::Author::OrHash],
          pagination:
            ModerationAPI::Models::AuthorListResponse::Pagination::OrHash
        ).returns(T.attached_class)
      end
      def self.new(authors:, pagination:)
      end
      ...
      sig do
        override.returns(
          {
            authors:
              T::Array[ModerationAPI::Models::AuthorListResponse::Author],
      ...
      class Author < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorListResponse::Author,
              ModerationAPI::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(ModerationAPI::Models::AuthorListResponse::Author::Block)
          )
        end
        attr_reader :block
        ...
        sig do
          params(
            block:
              T.nilable(
                ModerationAPI::Models::AuthorListResponse::Author::Block::OrHash
              )
          ).void
        end
        attr_writer :block
        ...
        sig do
          returns(ModerationAPI::Models::AuthorListResponse::Author::Metadata)
        end
        ...
        sig do
          params(
            metadata:
              ModerationAPI::Models::AuthorListResponse::Author::Metadata::OrHash
          ).void
        end
        attr_writer :metadata

        sig do
          returns(ModerationAPI::Models::AuthorListResponse::Author::Metrics)
        end
        attr_reader :metrics
        ...
        sig do
          params(
            metrics:
              ModerationAPI::Models::AuthorListResponse::Author::Metrics::OrHash
          ).void
        end
        attr_writer :metrics
        ...
        sig do
          params(
            risk_evaluation:
              T.nilable(
                ModerationAPI::Models::AuthorListResponse::Author::RiskEvaluation::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(ModerationAPI::Models::AuthorListResponse::Author::TrustLevel)
        end
          ...
          override.returns(
            {
              ...
              block:
                T.nilable(
                  ModerationAPI::Models::AuthorListResponse::Author::Block
                ),
              first_seen: Float,
              last_seen: Float,
              metadata:
                ModerationAPI::Models::AuthorListResponse::Author::Metadata,
              metrics:
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModerationAPI::Models::AuthorListResponse::Author::Status
              )
            end
      ...
      class Pagination < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorListResponse::Pagination,
              ModerationAPI::Internal::AnyHash
            )
          end
