  ...
  module Models
    class AuthorRetrieveResponse < ModerationAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::Models::AuthorRetrieveResponse,
      ...
      sig do
        returns(T.nilable(ModerationAPI::Models::AuthorRetrieveResponse::Block))
      end
      attr_reader :block
      ...
      sig do
        params(
          block:
            T.nilable(
              ModerationAPI::Models::AuthorRetrieveResponse::Block::OrHash
            )
        ).void
      end
      attr_writer :block
      ...
      sig { returns(ModerationAPI::Models::AuthorRetrieveResponse::Metadata) }
      attr_reader :metadata

      sig do
        params(
          metadata:
            ModerationAPI::Models::AuthorRetrieveResponse::Metadata::OrHash
        ).void
      end
      attr_writer :metadata

      sig { returns(ModerationAPI::Models::AuthorRetrieveResponse::Metrics) }
      attr_reader :metrics

      sig do
        params(
          metrics:
            ModerationAPI::Models::AuthorRetrieveResponse::Metrics::OrHash
        ).void
      end
      attr_writer :metrics
      ...
      sig do
        params(
          risk_evaluation:
            T.nilable(
              ModerationAPI::Models::AuthorRetrieveResponse::RiskEvaluation::OrHash
            )
        ).void
      end
      ...
      sig { returns(ModerationAPI::Models::AuthorRetrieveResponse::TrustLevel) }
        ...
        override.returns(
          {
            id: String,
            block:
              T.nilable(ModerationAPI::Models::AuthorRetrieveResponse::Block),
            first_seen: Float,
            last_seen: Float,
      ...
      class Block < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorRetrieveResponse::Block,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      class Metadata < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorRetrieveResponse::Metadata,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      class Metrics < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::Models::AuthorRetrieveResponse::Metrics,
              ModerationAPI::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModerationAPI::Models::AuthorRetrieveResponse::Status)
          end
