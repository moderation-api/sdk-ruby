...
module ModerationAPI
  module Models
    class AuthorUpdateParams < ModerationAPI::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::AuthorUpdateParams,
      ...
      sig { returns(T.nilable(ModerationAPI::AuthorUpdateParams::Metadata)) }
        ...
        override.returns(
          {
            ...
            last_seen: Float,
            manual_trust_level: T.nilable(Float),
            metadata: ModerationAPI::AuthorUpdateParams::Metadata,
            name: T.nilable(String),
            profile_picture: T.nilable(String),
      ...
      class Metadata < ModerationAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModerationAPI::AuthorUpdateParams::Metadata,
              ModerationAPI::Internal::AnyHash
            )
          end
