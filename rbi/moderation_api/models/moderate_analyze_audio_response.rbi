  ...
  module Models
    class ModerateAnalyzeAudioResponse < ModerationAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModerationAPI::Models::ModerateAnalyzeAudioResponse,
      ...
      sig do
        returns(
          T.nilable(ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author)
        )
      end
      attr_reader :author
      ...
      sig do
        params(
          author:
            T.nilable(
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::OrHash
            )
        ).void
      end
      attr_writer :author
      ...
      sig do
        returns(ModerationAPI::Models::ModerateAnalyzeAudioResponse::Request)
      end
      attr_reader :request
      ...
      sig do
        params(
          request:
            ModerationAPI::Models::ModerateAnalyzeAudioResponse::Request::OrHash
        ).void
      end
      attr_writer :request
        ...
        override.returns(
          {
            author:
              T.nilable(
                ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author
              ),
            flagged: T::Boolean,
            request:
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Request,
            status: String,
            content_id: String,
            error: T.anything
          }
      ...
      class Author < ModerationAPI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::Block
            )
          )
        end
        attr_reader :block
        ...
        sig do
          params(
            block:
              T.nilable(
                ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::Block::OrHash
              )
          ).void
        end
        attr_writer :block
        ...
        sig do
          returns(
            ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::Status::TaggedSymbol
          )
        end
        attr_accessor :status
        ...
        sig do
          returns(
            ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::TrustLevel
          )
        end
        ...
        sig do
          params(
            trust_level:
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::TrustLevel::OrHash
          ).void
        end
        ...
        sig do
          params(
            ...
            status:
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::Status::OrSymbol,
            trust_level:
              ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::TrustLevel::OrHash,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModerationAPI::Models::ModerateAnalyzeAudioResponse::Author::Status
              )
            end
