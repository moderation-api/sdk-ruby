...
class ModerationAPITest < Minitest::Test
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: ModerationAPI::Client::MAX_REDIRECTS) do
