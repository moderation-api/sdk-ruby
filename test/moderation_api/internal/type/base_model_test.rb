...
class ModerationAPI::Test::PrimitiveModelTest < Minitest::Test
  A = ModerationAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = ModerationAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < ModerationAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => ModerationAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [ModerationAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [ModerationAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [ModerationAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = ModerationAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        ModerationAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [ModerationAPI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [ModerationAPI::Internal::Type::Boolean, true] => true,
      [ModerationAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => ModerationAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        ModerationAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = ModerationAPI::Internal::Type::Converter.new_coerce_state
      ModerationAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        ModerationAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class ModerationAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include ModerationAPI::Internal::Type::Enum
...
class ModerationAPI::Test::CollectionModelTest < Minitest::Test
  A1 = ModerationAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = ModerationAPI::Internal::Type::HashOf[Integer]

  A2 = ModerationAPI::Internal::Type::ArrayOf[H1]
  H2 = ModerationAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = ModerationAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = ModerationAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class ModerationAPI::Test::BaseModelTest < Minitest::Test
  class M1 < ModerationAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < ModerationAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < ModerationAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, ModerationAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = ModerationAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = ModerationAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(ModerationAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue ModerationAPI::Errors::ConversionError => e
...
class ModerationAPI::Test::UnionTest < Minitest::Test
  class U0
    include ModerationAPI::Internal::Type::Union
  ...
  class M2 < ModerationAPI::Internal::Type::BaseModel
  ...
  class M4 < ModerationAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, ModerationAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < ModerationAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, ModerationAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class ModerationAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include ModerationAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [ModerationAPI::Internal::Type::Unknown, ModerationAPI::Internal::Type::Unknown] => true,
      [ModerationAPI::Internal::Type::Boolean, ModerationAPI::Internal::Type::Boolean] => true,
      [ModerationAPI::Internal::Type::Unknown, ModerationAPI::Internal::Type::Boolean] => false,
...
class ModerationAPI::Test::MetaInfoTest < Minitest::Test
  A1 = ModerationAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = ModerationAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
