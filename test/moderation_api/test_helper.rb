...
class ModerationAPI::Test::SingletonClient < ModerationAPI::Client
  include Singleton
...
class ModerationAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @moderation_api = ModerationAPI::Test::SingletonClient.instance
  end
